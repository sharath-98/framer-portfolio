...
const SkillCard = ({ icon, name, description, bg, shadow }) => {
	return (
		<div>
			<div
				className={`w-full h-[300px] p-8 rounded-[30px] flex items-center justify-center mb-6 relative overflow-hidden bg-accent hover:bg-primary/30 text-[#ffffff]  transition-all duration-200`}
			>
